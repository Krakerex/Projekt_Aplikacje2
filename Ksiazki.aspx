<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeBehind="Ksiazki.aspx.cs" Inherits="Projekt_Aplikacje2.Ksiazki" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        ...
        <div>
            ...
            <div>
                <label for="TitleTextBox">Tytuł:</label>
                <asp:TextBox ID="TitleTextBox" runat="server"></asp:TextBox>
            </div>
            <div>
                <label for="AuthorTextBox">Autor:</label>
        ...
        <div>
            ...
            <div class="no-results" id="NoResultsLabel" runat="server" visible="false">Brak wyników</div>
        </div>
